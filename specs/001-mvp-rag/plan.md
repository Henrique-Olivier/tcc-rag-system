...
A tela tem uma barra lateral recolhível com o botão de nova conversa, o link para a página **Documentos** e a lista de **Conversas**, e a área principal, que mostra o chat ou a página aberta. Os documentos ficam numa página própria (`/documentos`), com a largura toda para nomes longos e mensagens de erro.
