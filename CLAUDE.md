...
Estado atual: `specs/001-mvp-rag/spec.md` e `plan.md` (v4) estão aprovados. O `tasks.md` existe (T00 a T28); o scaffolding (T00) está feito e a implementação começa pela T01.
...
- **LLM:** Groq, via SDK da OpenAI (API compatível), atrás de uma interface `LLMProvider`. `llama-3.3-70b-versatile` para respostas, `llama-3.1-8b-instant` para reescrita de perguntas e títulos.
