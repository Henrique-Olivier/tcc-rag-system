...
Estado atual: `specs/001-mvp-rag/spec.md` e `plan.md` (v6) estão aprovados. O `tasks.md` existe (T00 a T28); o scaffolding (T00) está feito e a implementação começa pela T01.
